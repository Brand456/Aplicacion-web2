...
<body>
   ...
   <?php if(!empty($user)): ?>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                              class="form-control" name="medidaEditar" id="medidaEditar" aria-describedby="helpId" placeholder="Medida">
                ...
                <div class="card-body">
                   ...
                   <div class="mb-3">
                     ...
                     <div class="mb-3">
                      <label for="" class="form-label">Medidas:</label>
                      <input type="text"
                        class="form-control" name="medida" id="medida" aria-describedby="helpId" placeholder="Medida">
    ...
    <script>
    var url = "http://localhost/Aplicacion%20web/glucosa/";
   ...
   var aplicacion = new function()
   {
       ...
       this.medidaEditar = document.getElementById("medidaEditar");
       ...
       this.medida = document.getElementById("medida");
       this.hora = document.getElementById("hora");
       this.fecha = document.getElementById("fecha");

       this.glucosa = document.getElementById("glucosa");
       ...
       this.Leer= function()
       {
           ...
           .then((respuesta)=>{
               ...
               respuesta.map(
                   function(glucosa,index,array)
                   {
                       datos+="<tr>";
                       datos+="<td>"+glucosa.id+"</td>";
                       datos+="<td>"+glucosa.nombre+"</td>";
                       datos+="<td>"+glucosa.medida+"</td>";
                       datos+="<td>"+glucosa.hora+"</td>";
                       datos+="<td>"+glucosa.fecha+"</td>";
                       datos+='<td> <div class="btn-group" role="group" aria-label=""><button type="button" class="btn btn-info" onclick="aplicacion.Editar('+glucosa.id+')">Editar</button><button type="button" class="btn btn-danger" onclick="aplicacion.Borrar('+glucosa.id+')">Borrar</button></div>'+'</td>';
                       datos+="</tr>";
                       
                   }
               );

               return this.glucosa.innerHTML = datos;
           })
           .catch(console.log);
       ...
       this.agregar= function()
       {
           ...
           var datosEnviar = {medida:this.medida.value, nombre:this.nombre.value, hora:this.hora.value, fecha:this.fecha.value}
       ...
       {
           var datosEnviar = {medida:this.medidaEditar.value, nombre:this.nombreEditar.value, hora:this.horaEditar.value, fecha:this.fechaEditar.value}

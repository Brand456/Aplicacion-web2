                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                              class="form-control" name="nombreEditar" id="nombreEditar" aria-describedby="helpId" placeholder="nombreClave">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                              class="form-control" name="presionEditar" id="presionEditar" aria-describedby="helpId" placeholder="Medida">
            ...
            <div class="card">
                ...
                <div class="card-body">
                   ...
                   <div class="mb-3">
                      <label for="" class="form-label">Clave:</label>
                      <input type="text"
                        class="form-control" name="nombre" id="nombre" aria-describedby="helpId" placeholder="Clave">
                    ...
                    <div class="mb-3">
                      <label for="" class="form-label">Presion:</label>
                      <input type="text"
                        class="form-control" name="presion" id="presion" aria-describedby="helpId" placeholder="Presion">
...
<script>
    var url = "http://localhost/Aplicacion%20web/presion/";
   ...
   var aplicacion = new function()
   {
       ...
       this.presionEditar = document.getElementById("presionEditar");
       ...
       this.presions = document.getElementById("presions");
       ...
       this.Leer= function()
       {
           ...
           .then((respuesta)=>{
               ...
               respuesta.map(
                   function(presions,index,array)
                   {
                       datos+="<tr>";
                       datos+="<td>"+presions.id+"</td>";
                       datos+="<td>"+presions.nombre+"</td>";
                       datos+="<td>"+presions.presion+"</td>";
                       datos+="<td>"+presions.hora+"</td>";
                       datos+="<td>"+presions.fecha+"</td>";
                       datos+='<td> <div class="btn-group" role="group" aria-label=""><button type="button" class="btn btn-info" onclick="aplicacion.Editar('+presions.id+')">Editar</button><button type="button" class="btn btn-danger" onclick="aplicacion.Borrar('+presions.id+')">Borrar</button></div>'+'</td>';
                       datos+="</tr>";
                       
                   }
               );

               return this.presions.innerHTML = datos;
           })
           .catch(console.log);
       ...
       this.agregar= function()
       {
           ...
           var datosEnviar = {presion:this.presion.value, nombre:this.nombre.value, hora:this.hora.value, fecha:this.fecha.value}
       ...
       this.Editar = function(id)
       {
           ...
           .then((datosRespuesta)=>{
               ...
               this.presionEditar.value= datosRespuesta[0]['presion']
       ...
       {
           var datosEnviar = {id:this.idEditar.value, nombre:this.nombreEditar.value,  presion:this.presionEditar.value, hora:this.horaEditar.value, fecha:this.fechaEditar.value}
